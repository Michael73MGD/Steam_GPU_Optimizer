...
games_db_file = open('../Steam-Games-Scraper/games_example.json', encoding='utf-8')
...
for game in games_db:
    ...
    if type(pc_requirements) == dict:
        ...
        if 'Graphics: ' in cleaned_pc_reqs:
            ...
            possible_next_entry = ['DirectX: ', 'Storage: ', 'Hard Drive: ', 'Additional Notes: ']
